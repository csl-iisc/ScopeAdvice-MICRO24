...
nv-nsight-cu-cli --target-processes all --metrics smsp__average_warps_issue_stalled_membar_per_issue_active.ratio ./opt < ../../data/mm > $temp
...
# Generate nsight data for optimized run
nv-nsight-cu-cli --target-processes all --metrics smsp__average_warps_issue_stalled_membar_per_issue_active.ratio ./og < ../../data/mm > $temp
